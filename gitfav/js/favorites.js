import { GitHubFavorites } from "./githubAPI.js";
...
export class Favorites {
    ...
    async add(username) {
        ...
        try {
            ...
            const user = await new GitHubFavorites(username);
...
// Class to change html elements to show current data
export class FavoritesView extends Favorites {
    constructor(htmlElement) {
        super(htmlElement);
      
        document.querySelector("header button").onclick = () => {
            const username = document.querySelector("header input").value;
