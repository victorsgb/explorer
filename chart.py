...
finishing_dates = [
    ...
    date(2022, 8, 26)  # Expected to finish Stage 11
]

accumulated_progress = [0, .16, .25, .33, .42, .5, .58, .67, .75, .83, .92]
...
ax.text(
    mdates.date2num(finishing_dates[10]) - 16, accumulated_progress[10] + 0.005, 'in progress...',
    fontdict=text_font
)
